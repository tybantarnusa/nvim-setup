...
_G.packer_plugins = {
  ...
  ["buffer_manager.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/buffer_manager.nvim",
  ...
  ["cyberdream.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/cyberdream.nvim",
  ...
  ["trim.nvim"] = {
    ...
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/trim.nvim",
